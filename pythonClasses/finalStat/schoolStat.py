...
with open('/Users/nikitakhomenko/PycharmProjects/NeuralNetworkLab2/pythonProject/finalStat/final/schools_valid.json', 'r', encoding='utf-8') as file:
...
print("Процентное распределение среди школьников:")
